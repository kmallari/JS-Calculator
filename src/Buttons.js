const Buttons = ({ handleClick, handleEquate }) => {
  return (
    <div className="grid grid-cols-4 justify-items-center items-center max-w-md bg-gray-300 font-sans text-xl">
      ...
      <button value={"*"} onClick={handleClick} id="multiply" className="font-bold text-gray-500 bg-gray-100 w-24 h-24 ">×</button>
      ...
      <button value={0} onClick={handleClick} id="zero" className="col-start-2 col-end-3 font-bold text-gray-500 bg-gray-100 w-24 h-24 ">0</button>
      <button value={"."} onClick={handleClick} id="decimal" className="col-start-3 col-end-4 font-bold text-gray-500 bg-gray-100 w-24 h-24 ">.</button>
      <button value={"="} onClick={handleClick} id="equals" className="col-start-4 col-end-5 font-bold text-gray-500 bg-gray-100 w-24 h-24 ">=</button>
    </div>
  );
};
